      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col items-center self-stretch px-16 pb-20 mt-20 w-full text-lg leading-5 text-white max-md:px-5 max-md:mt-10 max-md:max-w-full break-all">
          <div className="flex flex-col mb-10 max-w-full w-[960px]">
            ...
            <div className="mt-16 text-5xl font-bold text-center max-md:mt-10 max-md:max-w-full max-md:text-4xl">
            ...
            <div className="mt-5 tracking-wide leading-6 max-md:max-w-full">
              ...
              and anyone can remix them. The more artworks are stored in EIS,
              the more remixable they become; we call this the network effect.
              The flywheel will start to jump up, then reach the astrosphere,
              and the public canvas will unlock the limit of human creativity.
            ...
            <div className="justify-center px-3 mt-5 italic tracking-wide leading-6 border-l-2 border-white border-solid max-md:max-w-full">
              ...
              rights so that no one is a rightsholder and the work belongs to
              the public. When you use CC0, you are releasing all rights under
              copyright and stating that you do not wish to have any control
              over the rights to the work—that the work is free for all uses by
              anyone.
            </div>
            ...
            <div className="justify-center px-3 mt-5 italic tracking-wide leading-6 border-l-2 border-white border-solid max-md:max-w-full">
              ...
              good)is a good that is both non-excludable and non-rivalrous. Use
              by one person neither prevents access by other people, nor does it
            ...
            <div className="mt-5 tracking-wide leading-6 max-md:max-w-full">
              ...
              providers. This is something we have learned from blockchain
              itself, as well as from examples like Uniswap and Nouns.
            </div>
            <div className="mt-16 text-2xl font-bold tracking-wide max-md:mt-10 max-md:max-w-full">
            ...
            <div className="mt-5 tracking-wide leading-6 max-md:max-w-full">
              ...
              <ol className="list-decimal ml-6 space-y-4">
                <li>
                  ...
                  recalculate the math behind the image so there is no
                  distortion. Raster images on the other hand lose their
                  resolution when enlarged because their small pixels are forced
                  to expand beyond their original size.
                </li>
                ...
                <li>
                  Compact file-size – Pixel-based images are saved at a large
                  size from the start because you can only retain the quality
                  when you make the image smaller, but not when you make it
                  larger. This can impact a site’s download speed. Since SVGs
                  are scalable, they can be saved at a minimal file size.
                </li>
              </ol>
              <br />
              Reference:{" "}
            ...
            <div className="mt-5 tracking-wide leading-6 max-md:max-w-full">
              A crucial aspect of CC0 NFT is that more propagated artwork
              captures value. Propagation includes SNS virality and derivative
              creations, facilitated by blockchain technology. EIS supports this
              by enabling such artwork to earn revenue through revenue
              streaming. Creators of well-propagated artwork will profit from
