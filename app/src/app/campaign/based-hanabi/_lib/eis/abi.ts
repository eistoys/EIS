export const eisHanabiAbi = [
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "collectionOwnerFeeBasisPoints_",
        type: "uint256",
      },
      {
        internalType: "uint256",
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          {
            internalType: "enum EISHanabi.Compression",
        ...
        indexed: false,
        internalType: "struct EISHanabi.Record",
        name: "record",
        type: "tuple",
      },
      {
  ...
  },
  {
    ...
    name: "getDividedFeesFromTotalMintFee",
    outputs: [
      {
        internalType: "uint256",
        name: "",
